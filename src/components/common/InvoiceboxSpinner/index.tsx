...
export const InvoiceboxSpinner: FC<TProps> = ({ isSecondary = false, palette, width = '100%' }) => {
        ...
        <S.Wrapper $width={width}>
            <svg width="100%" viewBox="0 0 99 51" fill="none">
                ...
                <path
                    ...
                    fill={isSecondary ? mergedPalette.rightEyeSecondary : mergedPalette.rightEyePrimary}
                />
                {/* right eye */}
                <path
                    d="M94 22.5C94 32.062 86.0453 40 76 40C65.9547 40 58 32.062 58 22.5C58 12.938 65.9547 5 76 5C86.0453 5 94 12.938 94 22.5Z"
                    stroke={isSecondary ? mergedPalette.rightEyeSecondary : mergedPalette.rightEyePrimary}
                    strokeWidth="10"
                    id="right-eye"
                />
                {/* left eye */}
                <path
                    ...
                    stroke={isSecondary ? mergedPalette.leftEyeSecondary : mergedPalette.leftEyePrimary}
                    strokeWidth="6"
                    id="left-eye"
                />
            </svg>
