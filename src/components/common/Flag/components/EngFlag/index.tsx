...
export const EngFlag = () => (
    <svg width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            ...
            fill="white"
        />
        <path id="vector_2" d="M0.780579 0L22 14.4378V16H21.2377L0 1.54726V0H0.780579Z" fill="#F93939" />
        <path
            id="vector_3"
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill="white"
        />
        <path id="vector_4" d="M22 0H21.2895L0 14.4502V16H0.780579L22 1.55895V0Z" fill="#F93939" />
        <path
            id="vector_5"
            fillRule="evenodd"
            clipRule="evenodd"
