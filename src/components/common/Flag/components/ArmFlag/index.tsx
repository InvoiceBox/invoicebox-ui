    ...
    <svg width="100%" height="100%" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_216_201728)">
            <path
                ...
                fill="#1A47B8"
            />
            <path fillRule="evenodd" clipRule="evenodd" d="M0 11H22V16H0V11Z" fill="#FFDA2C" />
            <path fillRule="evenodd" clipRule="evenodd" d="M0 0H22V5H0V0Z" fill="#F93939" />
        </g>
        <defs>
            <clipPath id="clip0_216_201728">
